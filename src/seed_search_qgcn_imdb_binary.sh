...
echo "=============================="
echo "QGCN | IMDB-BINARY | GPU $GPU"
echo "Seeds: ${SEEDS[*]}"
echo "=============================="

for SEED in "${SEEDS[@]}"; do
    LOG="../training_results/qgcn_imdb_binary_seed${SEED}.log"
    echo ""
    echo ">>> [QGCN/IMDB-BINARY] Seed=$SEED"
    CUDA_VISIBLE_DEVICES=$GPU python train_quantum_models.py \
        --datasets imdb_binary --seed "$SEED" \
...
echo ""
echo "=============================="
echo "QGCN/IMDB-BINARY  BEST SEED: $BEST_SEED  (mean acc=$BEST_ACC)"
echo "=============================="
