...
echo "=============================="
echo "QGCN | IMDB-MULTI | GPU $GPU"
echo "Seeds: ${SEEDS[*]}"
echo "=============================="

for SEED in "${SEEDS[@]}"; do
    LOG="../training_results/qgcn_imdb_multi_seed${SEED}.log"
    echo ""
    echo ">>> [QGCN/IMDB-MULTI] Seed=$SEED"
    CUDA_VISIBLE_DEVICES=$GPU python train_quantum_models.py \
        --datasets imdb_multi --seed "$SEED" \
...
echo ""
echo "=============================="
echo "QGCN/IMDB-MULTI  BEST SEED: $BEST_SEED  (mean acc=$BEST_ACC)"
echo "=============================="
