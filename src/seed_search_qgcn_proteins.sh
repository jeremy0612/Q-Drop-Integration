...
echo "=============================="
echo "QGCN | PROTEINS | GPU $GPU"
echo "Seeds: ${SEEDS[*]}"
echo "=============================="

for SEED in "${SEEDS[@]}"; do
    LOG="../training_results/qgcn_proteins_seed${SEED}.log"
    echo ""
    echo ">>> [QGCN/PROTEINS] Seed=$SEED"
...
echo ""
echo "=============================="
echo "QGCN/PROTEINS  BEST SEED: $BEST_SEED  (mean acc=$BEST_ACC)"
echo "=============================="
